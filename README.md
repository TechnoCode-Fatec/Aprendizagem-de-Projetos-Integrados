...
| **F05** | **Visualização de orientadores** | Como professor de TG, quero visualizar os orientadores e seus alunos atribuídos, para ter noção de como estão sendo as orientações. | Cliente visualiza orientadores e respectivas orientações sem erros. | 🔸 Média | ⏳ Planejado |
